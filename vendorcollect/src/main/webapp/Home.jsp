...
<script language="javascript"> 
	function ValidationEvent() {				
		...
		if (datafor.value == "") {
			...
			document.getElementById("datafor").disabled = false; 
			return false;
		}
		if (masterFile.value == "") {
	...
	<div id="container">
		<div id="content">
			...
			<div style="text-align: center;">
				<hr />
				<b>Auto Gauging Data Upload Utility</b> <br />
				<hr />
			</div>
			<div id="main" style="height: 500px;">
				...
				<div style="width: 60%; float: left; height: 100%;">
					<form action="Import_MasterDataControl" method="post"
									...
									style="font-weight: bold;">
										...
										<%
											if (access.equalsIgnoreCase("FULL")  && is_cust==0) {
													...
													PreparedStatement ps_vendor = conMaster
										...
										<%
													...
													String query = "SELECT  *  FROM Baker_site where enable=1  and sapcode= '"
															+ vendor_Code + "'";
													PreparedStatement ps_vendor = conMaster
															.prepareStatement(query);
													ResultSet rs_vendor = ps_vendor.executeQuery();
